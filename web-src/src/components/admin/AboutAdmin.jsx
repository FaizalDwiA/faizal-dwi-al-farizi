...
export default function AboutAdmin() {
  const { label, title, desc, intro, quote, photoInfo, cards } = adminData.about;
      ...
      <div className="section-inner">
        ...
        <div className="about-grid">
          ...
          <div className="about-intro fade-in visible" style={{ transitionDelay: '0.1s' }}>
            ...
            <p>Bagi saya, akurasi pencatatan data dan kelancaran operasional komputer pendukung adalah prioritas utama. Saya siap beradaptasi dengan cepat dan mengabdikan ketelitian saya untuk kerapian administrasi serta manajemen stok barang.</p>
