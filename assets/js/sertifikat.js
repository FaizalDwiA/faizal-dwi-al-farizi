...
const sertifikatData = [
	// === Sertifikat Magang ===
	{
		kategori: "magang",
		meta: "Magang",
		title: "Sertifikat Magang CV. Rosin",
		img: "assets/img/sertifikat/magang/Sertifikat Magang CV Rosin.webp",
		gallery: "portfolio-gallery-ui",
		desc: "📌 Bukti telah menyelesaikan program magang di CV. Rosin dengan pengalaman langsung di bidang pemrograman dan pengembangan sistem.",
		// link: "portfolio-details.html",
	},
	// === End Sertifikat Magang ===

	// === Sertifikat WMK ===
	{
		kategori: "wmk",
		meta: "WMK",
		title: "Sertifikat WMK",
		img: "assets/img/sertifikat/wmk/2023_Sertifikat WMK.webp",
		gallery: "portfolio-gallery-ui",
		desc: "📌 Sertifikat program Wirausaha Merdeka (WMK) sebagai bentuk partisipasi dan penyelesaian pelatihan kewirausahaan berbasis proyek nyata.",
		// link: "portfolio-details.html",
	},
	{
		kategori: "wmk",
		meta: "WMK",
		title: "Penilaian WMK",
		img: "assets/img/sertifikat/wmk/2023_Penilaian WMK.webp",
		gallery: "portfolio-gallery-ui",
		desc: "📌 Hasil penilaian kinerja selama mengikuti program Wirausaha Merdeka (WMK), mencakup kreativitas, inovasi, dan pengelolaan proyek.", // link: "portfolio-details.html",
	},
	{
		kategori: "wmk",
		meta: "WMK",
	...
	// === Sertifikat FreeCodeCamp ===
	{
		...
		img: "assets/img/sertifikat/freecodecamp/Responsive Web Design.webp",
		gallery: "portfolio-gallery-ui",
	...
	},
	{
		...
		img: "assets/img/sertifikat/solo learn/Generative AI in Practice_certificate.webp",
		gallery: "portfolio-gallery-ui",
	...
	},
	{
		...
		img: "assets/img/sertifikat/solo learn/ML for beginners.webp",
		gallery: "portfolio-gallery-ui",
	...
	},
	{
		...
		meta: "SOLO LEARN",
		title: "SEO with AI",
		img: "assets/img/sertifikat/solo learn/SEO with AI.webp",
		gallery: "portfolio-gallery-ui",
	...
	// === Sertifikat Indonusa ===
	{
		kategori: "indonusa",
		meta: "INDONUSA",
		title: "Predikat Kelulusan Cumlaude",
		img: "assets/img/sertifikat/indonusa/2025-10-20_Sertifikat Cumlaude.webp",
		gallery: "portfolio-gallery-ui",
		desc: "🎓 Penghargaan atas pencapaian akademik dengan predikat *Cumlaude* sebagai bentuk apresiasi terhadap dedikasi, konsistensi, dan prestasi selama menempuh studi di Program Studi Teknologi Rekayasa Perangkat Lunak, Politeknik Indonusa Surakarta.",
		// link: "portfolio-details.html",
	},
	...
	// === Sertifikat SMK ===
	{
		kategori: "smk",
		meta: "SMK",
		title: "Sertifikat Prakerin SMK",
		img: "assets/img/sertifikat/smk/Sertifikat Prakerin Lubna Computer.webp",
		gallery: "portfolio-gallery-ui",
		desc: "📌 Sertifikat Praktik Kerja Industri (Prakerin) SMK sebagai bukti pengalaman kerja lapangan yang relevan dengan bidang keahlian.", // link: "portfolio-details.html",
	},
	{
		kategori: "smk",
		meta: "SMK",
		title: "Sertifikat UKOM SMK",
		img: "assets/img/sertifikat/smk/UKOM SMK.webp",
		gallery: "portfolio-gallery-ui",
		desc: "📌 Bukti kelulusan Uji Kompetensi (UKOM) SMK sebagai pengakuan atas keterampilan dan kemampuan sesuai standar kompetensi.", // link: "portfolio-details.html",
	},
	{
		kategori: "smk",
		meta: "SMK",
		title: "Penilaian UKOM SMK",
		img: "assets/img/sertifikat/smk/Penilaian UKOM SMK.webp",
		gallery: "portfolio-gallery-ui",
		desc: "📌 Laporan hasil penilaian Uji Kompetensi (UKOM) SMK yang mencakup kemampuan teknis dan penerapan keahlian secara praktis.", // link: "portfolio-details.html",
	},
	// === End Sertifikat SMK ===
];
